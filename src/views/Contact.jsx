import './Contact.css'; // Make sure to add the necessary CSS for styles
      ...
      <div className="google-signup mt-5">
        ...
        <a href="https://accounts.google.com/signin" target="_blank" rel="noopener noreferrer">
          <button className="btn btn-google">
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/51/Google.png" alt="Google logo" className="google-logo" />
            Sign Up with Google
          </button>
        </a>
      </div>
