import './About.css'; // Make sure to add the necessary CSS
    ...
    <div className="about-container container mt-5">
      ...
      <section className="mission-section">
        ...
        <div className="mission-content">
          ...
          <img 
            src="https://upload.wikimedia.org/wikipedia/commons/2/2d/Orange_tabby_cat_looking.jpg" 
            alt="Adorable Cat" 
      ...
      <section className="get-involved-section">
        ...
        <p>If you want to help, there are many ways you can get involved. You can donate, volunteer, or even foster a cat until they find their forever home.</p>
