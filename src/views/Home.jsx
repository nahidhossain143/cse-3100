...
const featuredCats = [
  ...
  { name: 'Chester', age: '4', breed: 'Oriental Shorthair' },
  { name: 'Nala', age: '2', breed: 'Maine Coon' },
  { name: 'Milo', age: '2', breed: 'Ragdoll' },
];
    ...
    <>
      <section className="text-center mt-4">
        ...
        <p className="lead-text">
          Find your perfect feline companion today! We have cats of all breeds and personalities, just waiting to meet you.
        </p>
      </section>
